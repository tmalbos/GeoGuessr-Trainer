...
def test_ci_is_none_when_sample_is_too_small():
...
def test_ci_bounds_are_in_correct_order():
...
def test_ci_is_deterministic_with_same_seed():
...
def test_ci_is_tight_when_all_values_are_identical():
